...
+(function (o) {
  ...
  function t(t) {
    return this.each(function () {
      ...
      void 0 !== e.data("animations") &&
        null !== e.data("animations") &&
        (i.animations = o.isArray(i.animations)
          ? i.animations
          : i.animations.split(" "));
  ...
  (n.TRANSITION_DURATION = 300),
    ...
    (n.prototype.show = function (t) {
      ...
      if (!e.is(".disabled, :disabled")) {
        ...
        if (!s) {
          ...
          (r =
            "top" == a
              ? this.options.animations[2]
              : "right" == a
              ? this.options.animations[3]
              : "left" == a
              ? this.options.animations[1]
    ...
    (n.prototype.position = function (t) {
      var n = o(window);
      t.css({ bottom: "", left: "", top: "", right: "" }).removeClass(
        "dropdownhover-top"
      );
      ...
      if (d)
        i.left < 0
          ? ((s = "left"),
            t.removeClass("dropdownhover-right").addClass("dropdownhover-left"))
          : ((s = "right"),
            t
          ...
          r.bottom > e.bottom
            ? t.css({ bottom: "auto", top: -(r.bottom - e.bottom) })
            : r.top < e.top && t.css({ bottom: -(e.top - r.top), top: "auto" });
      else {
        ...
        (h.right = h.left + a.outerWidth()),
          ...
          r.right > e.right &&
            t.css({ left: -(r.right - e.right), right: "auto" }),
          (r.bottom > e.bottom && h.top - e.top > e.bottom - h.bottom) ||
          t.position().top < 0
            ? ((s = "top"),
              t
            ...
            : ((s = "bottom"), t.addClass("dropdownhover-bottom"));
      }
      return s;
    });
          ...
          o(window).width() >= 768
            ...
            : o('[data-hover="dropdown"]').each(function () {
                o(this).removeData("bs.dropdownhover"),
                  o(this).hasClass("dropdown-toggle")
                    ? o(this)
                        .parent(".dropdown")
                        .find(".dropdown")
                        .andSelf()
                        .off(
                          "mouseenter.bs.dropdownhover mouseleave.bs.dropdownhover"
                        )
                    : o(this)
                        .find(".dropdown")
                        .off(
